...
class CommonUtil:
    ...
    def selfcure_modeling_creation(training_features_df):
        ...
        """
        info(training_features_df.columns)        
        ...
        train_data = training_features_df.copy()
    ...
    def get_selfcure_lr_prediction(self, testing_data, customer_history_data, model):
        ...
        testing_data["due_date_deviation"] = (testing_data["due_date_deviation"].dt.days)
        ...
        # Commenting after removing Min max
        #min_max_scaler = MinMaxScaler()
        ...
        testing_data["prediction"] = np.where(testing_data["probability_of_being_on_time"] >= 0.7, 0, 1)
        testing_data["confidence_to_pay_on_time"] = np.where(testing_data["probability_of_being_on_time"] >= 0.7, "high", "low")
        # return predictions
